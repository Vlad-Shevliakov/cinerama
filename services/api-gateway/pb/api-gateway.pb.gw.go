...
var (
	pattern_APIGatewayService_HandShake_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "hello", "name"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	pattern_AuthService_SignUp_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "signup"}, "", runtime.AssumeColonVerbOpt(true)))
)
